...
GO
CREATE VIEW "DBO".DAXINVSUMSITELOCATIONVIEW AS 
SELECT T1.ITEMID AS ITEMID,
       T1.NAMEALIAS AS NAMEALIAS,
       T1.DATAAREAID AS DATAAREAID1,
       T1.DATAAREAID AS DATAAREAID,
       T1.PARTITION AS PARTITION,
       1010 AS RECID,
       SUM(T2.AVAILPHYSICAL) AS AVAILPHYSICAL,
       SUM(T2.AVAILORDERED) AS AVAILORDERED,
       SUM(T2.PHYSICALINVENT) AS PHYSICALINVENT,
       SUM(T2.RESERVPHYSICAL) AS RESERVPHYSICAL,
       SUM(T2.PDSCWAVAILORDERED) AS PDSCWAVAILORDERED,
       T2.DATAAREAID AS DATAAREAID#2,
       T2.PARTITION AS PARTITION#2,
       T2.PDSCWPHYSICALINVENT AS PDSCWPHYSICALINVENT,
       T3.DATAAREAID AS DATAAREAID#3,
