...
SELECT T1.RECID AS RECID1,
       ...
       T2.PARTITION AS PARTITION#2,
       T3.PARTITION AS PARTITION#3,
       T3.LANGUAGEID AS LANGUAGEID,
       T3.NAME AS NAME
FROM INVENTTABLE T1
CROSS JOIN ECORESPRODUCT T2
CROSS JOIN ECORESPRODUCTTRANSLATION T3
WHERE (T1.PRODUCT=T2.RECID
       AND (T1.PARTITION = T2.PARTITION))
  AND (T3.PRODUCT=T2.RECID
